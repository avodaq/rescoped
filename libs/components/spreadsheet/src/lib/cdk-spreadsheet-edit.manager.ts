...
/**
 * The CDK_EDIT_TAG_CLASS is a unique identifier whose use should match the CdkSpreadsheetEdit
 * interface in the directive where it is used.
 *
 * @example CdkSpreadsheetEditDirective in cdk-spreadsheet-edit.directive.ts
 */
export const CDK_EDIT_TAG_CLASS = 'cdk-spreadsheet-edit';

/**
 * The CDK_EDIT_CSS_CLASS is used to query the proper html dom node reference in order to get the
 * directive instance of CdkSpreadsheetEdit interface.
 */
 ...
 * CdkSpreadsheetEdit.
 */
export type CdkMapEdit = Map<HTMLElement, CdkSpreadsheetEdit>;
 ...
 * @example CdkSpreadsheetEditDirective in cdk-spreadsheet-edit.directive.ts
 */
export interface CdkSpreadsheetEdit {
  activeEdit(): void;
  inactiveEdit(): void;
}
...
/**
 * CdkSpreadsheetEditManager provides some useful methods for write, read, delete or interacting
 * with directive instances of CdkSpreadsheetEdit.
 *
 * @example test/cdk-spreadsheet-edit.manager.spec.ts
 */
@Injectable()
export class CdkSpreadsheetEditManager<
  Element extends HTMLElement = HTMLElement,
  _Event extends EventWithTarget<Element> = EventWithTarget<Element>,
  Editable extends CdkSpreadsheetEdit = CdkSpreadsheetEdit,
> {
  /**
  ...
  /**
   * @see CdkMapEdit in cdk-spreadsheet-edit.manager.ts
   *
   * @internal
   **/
  ...
  /**
   * The #lastEditItemRef is the last edited CdkSpreadsheetEdit reference.
   *
   * @internal
   */
  #lastEditItemRef: CdkSpreadsheetEdit | undefined;
   ...
   * with CdkSpreadsheetEdit.activeEdit() and CdkSpreadsheetEdit.inactiveEdit().
   */
