...
import { SPREADSHEET_STORAGE_TOKEN } from './cdk-spreadsheet-storage.factory';
import { CdkSpreadsheetStorageDirective } from './cdk-spreadsheet-storage.directive';
import { takeUntil, tap } from 'rxjs/operators';
import { FieldValidationErrors } from './cdk-spreadsheet.validators';
...
export class CdkSpreadsheetFormControlDirective<Item> implements OnInit, OnDestroy {
  constructor(
  ...
  @Input() validator: SpreadsheetValidation = {
    validator: [],
    asyncValidator: [],
    updateOn: 'submit',
  };
